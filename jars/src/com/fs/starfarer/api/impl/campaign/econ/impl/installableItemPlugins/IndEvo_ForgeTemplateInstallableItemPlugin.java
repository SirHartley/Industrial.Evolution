...
import com.fs.starfarer.api.impl.campaign.econ.impl.derelicts.IndEvo_BaseForgeTemplateUser;
...
public class IndEvo_ForgeTemplateInstallableItemPlugin extends BaseInstallableIndustryItemPlugin {
    ...
    public static final Map<String, IndEvo_ForgeTemplateInstallableItemPlugin.ForgeTemplateEffect> FORGETEMPLATE_EFFECTS = new HashMap<String, IndEvo_ForgeTemplateInstallableItemPlugin.ForgeTemplateEffect>() {{
        //put entries for Forge template 1-5 onto the list without duplicates
        for (int i = 1; i <= 5; i++) {
            put(IndEvo_Items.FORGETEMPLATE + "_" + i, new IndEvo_ForgeTemplateInstallableItemPlugin.ForgeTemplateEffect() {
        ...
        put(IndEvo_Items.EMPTYFORGETEMPLATE, new IndEvo_ForgeTemplateInstallableItemPlugin.ForgeTemplateEffect() {
            public void apply(Industry industry, SpecialItemData specItem) {
            }
        ...
        put(IndEvo_Items.BROKENFORGETEMPLATE, new IndEvo_ForgeTemplateInstallableItemPlugin.ForgeTemplateEffect() {
            public void apply(Industry industry, SpecialItemData specItem) {
                if (industry instanceof IndEvo_BaseForgeTemplateUser) {
                    IndEvo_BaseForgeTemplateUser b = (IndEvo_BaseForgeTemplateUser) industry;
                    b.setForgeShip(Global.getSettings().getHullSpec(specItem.getData()));
    ...
    public IndEvo_ForgeTemplateInstallableItemPlugin(IndEvo_BaseForgeTemplateUser industry) {
    ...
    public void addItemDescription(TooltipMakerAPI text, SpecialItemData data,
        ...
        IndEvo_ForgeTemplateInstallableItemPlugin.ForgeTemplateEffect effect = FORGETEMPLATE_EFFECTS.get(data.getId());
        if (effect != null) {
