...
public class IndEvo_IntArrayEntityPlugin extends BaseCampaignObjectivePlugin {
    ...
    public void advance(float amount) {
        ...
        for (MarketAPI market : IndEvo_IndustryHelper.getMarketsInLocation(entity.getContainingLocation())) {
