...
import com.fs.starfarer.api.impl.campaign.econ.impl.IndEvo_SharedSubmarketUserAPI;
...
public class IndEvo_SharedStoragePlugin extends BaseSubmarketPlugin implements IndEvo_DynamicSubmarket {
    ...
    public static List<Industry> getSharedStorageUsers(MarketAPI market) {
        ...
        for (Industry ind : market.getIndustries()) {
            if (ind instanceof IndEvo_SharedSubmarketUserAPI) {
                l.add(ind);
            }
        }
    ...
    public boolean isIllegalOnSubmarket(CargoStackAPI stack, TransferAction action) {
        ...
        for (Industry ind : getSharedStorageUsers(market)) {
            boolean allowed = ((IndEvo_SharedSubmarketUserAPI) ind).isLegalOnSharedSubmarket(stack);
    ...
    protected void createTooltipAfterDescription(TooltipMakerAPI tooltip, boolean expanded) {
        ...
        for (Industry ind : getSharedStorageUsers(market)) {
            ((IndEvo_SharedSubmarketUserAPI) ind).addTooltipLine(tooltip, expanded);
        }
    }
