...
public class IndEvo_BlueprintInstallableItemPlugin extends BaseInstallableIndustryItemPlugin {
    ...
    private final IndEvo_EngHub industry;

    public IndEvo_BlueprintInstallableItemPlugin(IndEvo_EngHub industry) {
