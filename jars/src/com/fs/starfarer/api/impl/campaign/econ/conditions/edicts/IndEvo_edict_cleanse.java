...
import com.fs.starfarer.api.impl.campaign.econ.impl.IndEvo_senate;
...
public class IndEvo_edict_cleanse extends IndEvo_baseEdict implements MarketImmigrationModifier {
    ...
    public int getMinRuntime() {
        ...
        return senateHasBetaCore() ? minRunTime - IndEvo_senate.EDICT_RUNTIME_DAY_RED : minRunTime;
    }
    ...
    public boolean isPresenceConditionMet(MarketAPI market) {
        return super.isPresenceConditionMet(market) && IndEvo_IndustryHelper.marketHasMilitaryIncludeRelays(market) && marketHasConditionSubString(market, "ubpopulation");
    }
