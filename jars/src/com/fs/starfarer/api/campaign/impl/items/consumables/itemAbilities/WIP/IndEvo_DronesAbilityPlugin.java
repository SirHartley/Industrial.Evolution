...
public class IndEvo_DronesAbilityPlugin extends IndEvo_BaseConsumableAbilityPlugin {

    @Override
    protected void activateImpl() {
        //check MakeshiftEquipment for survey cost red
    }

    @Override
    public float getDurationDays() {
        return super.getDurationDays();
    }
