package com.fs.starfarer.api.campaign.impl.items.consumables.itemAbilities.WIP;

import com.fs.starfarer.api.Global;
import com.fs.starfarer.api.campaign.impl.items.consumables.itemAbilities.IndEvo_BaseConsumableAbilityPlugin;
import com.fs.starfarer.api.ui.TooltipMakerAPI;
import com.fs.starfarer.api.util.Misc;

import java.awt.*;

public class IndEvo_StabilizerAbilityPlugin extends IndEvo_BaseConsumableAbilityPlugin {

    @Override
    protected void activateImpl() {
        //check HullRestoration skill
        //makes ships always recoverable and get less D mods
    }
