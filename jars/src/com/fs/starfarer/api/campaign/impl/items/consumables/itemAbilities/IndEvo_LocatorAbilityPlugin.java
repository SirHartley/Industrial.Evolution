...
public class IndEvo_LocatorAbilityPlugin extends IndEvo_BaseConsumableAbilityPlugin {
    ...
    protected IndEvo_LocatorScanData data = null;
    ...
    protected void applyEffect(float amount, float level) {
        ...
        if (data == null) {
            data = new IndEvo_LocatorScanData(this);
        }
