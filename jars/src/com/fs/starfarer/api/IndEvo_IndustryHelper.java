...
import com.fs.starfarer.api.plugins.IndEvo_SessionTransientMemory;
import com.fs.starfarer.api.plugins.addOrRemovePlugins.IndEvo_PlanetMovingScript;
...
public class IndEvo_IndustryHelper {
    public static final Logger log = Global.getLogger(IndEvo_IndustryHelper.class);
    ...
    public static CargoAPI getIndustrialStorageCargo(MarketAPI market) {
        ...
        SubmarketAPI submarket = market.getSubmarket(IndEvo_ids.SHAREDSTORAGE);
    ...
    public static List<ShipHullSpecAPI> getAllLearnableShipHulls() {
        IndEvo_SessionTransientMemory transientMemory = IndEvo_SessionTransientMemory.getInstance();
    ...
    public static CargoAPI getCargoCopy(CargoAPI source) {
        ...
        for (FleetMemberAPI member : source.getMothballedShips().getMembersListCopy()) {
            copy.getMothballedShips().addFleetMember(IndEvo_IndustryHelper.createFleetMemberClone(member));
        }
    ...
    public static Map<String, Float> getMapFromMemory(String key) {
        ...
        return IndEvo_IndustryHelper.sortByLargestValue(prlist);
    }
    ...
    public static ShipVariantAPI stripShipToCargoAndReturnVariant(FleetMemberAPI member, MarketAPI market) {
        MarketAPI target = IndEvo_IndustryHelper.getMarketForStorage(market);
    ...
    public static List<MarketAPI> getMarketsInLocation(LocationAPI location, String factionId) {
        List<MarketAPI> result = new ArrayList<>();
        for (MarketAPI curr : IndEvo_IndustryHelper.getMarketsInLocation(location)) {
    ...
    public static boolean marketHasMilitaryIncludeRelays(MarketAPI market, boolean onlyFunctional) {
        ...
        boolean checkPresenceMilArray = market.hasIndustry(IndEvo_ids.INTARRAY) && (!onlyFunctional || market.getIndustry(IndEvo_ids.INTARRAY).isFunctional());
        boolean checkPresenceIntArray = market.hasIndustry(IndEvo_ids.COMARRAY) && (!onlyFunctional || market.getIndustry(IndEvo_ids.COMARRAY).isFunctional());
    ...
    public static boolean isOnlyInstanceInSystemExcludeMarket(String id, StarSystemAPI system, MarketAPI excludeMarket, FactionAPI faction) {
        ...
        List<MarketAPI> marketsInLocation = IndEvo_IndustryHelper.getMarketsInLocation(system, faction.getId());
