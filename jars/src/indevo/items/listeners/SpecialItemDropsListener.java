...
public class SpecialItemDropsListener implements ShowLootListener {
        ...
        for (SalvageEntityGenDataSpec.DropData data : dropData) {
            ...
            if (data.group.equals("rare_tech") || data.group.equals("rare_tech_low")) {
                ...
                if (value != -1) {
                    ...
                    ModPlugin.log(String.format("Added [%s] value and [%s] valueMult to DropData", dropValue.value, dropValue.valueMult));
    ...
    private static List<SalvageEntityGenDataSpec.DropData> generateDropRandomList(List<SalvageEntityGenDataSpec.DropData> dropData) {
        ...
        for (SalvageEntityGenDataSpec.DropData data : dropData) {
            ...
            ModPlugin.log(String.format("DropData " + data.group + " [%s] chances and [%s] maxChances", data.chances, data.maxChances));
            ...
            if (data.group.contains("_tech")) {
                ...
                if (chances != -1) {
                    ...
                    ModPlugin.log(String.format("Added [%s] chances and [%s] maxChances to DropData", dropRandom.chances, dropRandom.maxChances));
