...
public class ScoopAbilityPlugin extends BaseConsumableAbilityPlugin {
    //vectors suck
    ...
    protected void applyEffect(float amount, float level) {
        ...
        if (active && interval.intervalElapsed() && canSucc()) {
            ...
            //ModPlugin.log("particle check - " + particleNum + " allowed " + maxParticles);
    ...
    public void render(CampaignEngineLayers layer, ViewportAPI viewport) {
        ...
        if(sprite == null || spriteNoColour == null || age != this.age){
            ...
            ModPlugin.log("sprite null, loading " + nebulaType);
        }
