...
public class ForgeTemplateData extends SpecialItemData {

    private final ShipVariantAPI variant;

    public ForgeTemplateData(String id, String data, ShipVariantAPI var) {
        super(id, data);
        this.variant = var;
    }
    ...
    public boolean equals(Object obj) {
        ...
        ForgeTemplateData other = (ForgeTemplateData) obj;
        if (getData() == null) {
