...
public class ExtraFuelSpecial extends BaseSalvageSpecial {
    ...
    public static class ExtraFuelSpecialData implements SalvageSpecialInteraction.SalvageSpecialData {
        public final ExtraFuelSpecial.ExtraFuelSpecialType type;
        public final int min;
        public final int max;

        public ExtraFuelSpecialData(ExtraFuelSpecial.ExtraFuelSpecialType type, int min, int max) {
            this.type = type;
            this.min = min;
            this.max = max;
        }
        ...
        public SalvageSpecialInteraction.SalvageSpecialPlugin createSpecialPlugin() {
            return new ExtraFuelSpecial();
        }
    }

    private ExtraFuelSpecial.ExtraFuelSpecialData data;

    private int quantity = 1;

    public ExtraFuelSpecial() {
    }
    ...
    public void init(InteractionDialogAPI dialog, Object specialData) {
        ...
        data = (ExtraFuelSpecial.ExtraFuelSpecialData) specialData;
        ...
        ExtraFuelSpecial.ExtraFuelSpecialType type = data.type;
