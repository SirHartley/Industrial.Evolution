...
import static indevo.industries.RestorationDocks.getBaseShipHullSpec;
import static indevo.industries.RestorationDocks.getListNonBuiltInDMods;

public class DModRepairSpecial extends BaseSalvageSpecial {
    ...
    public static class DModRepairSpecialData implements SalvageSpecialInteraction.SalvageSpecialData {
        ...
        public SalvageSpecialInteraction.SalvageSpecialPlugin createSpecialPlugin() {
            return new DModRepairSpecial();
        }
    }

    private DModRepairSpecial.DModRepairSpecialData data;

    public DModRepairSpecial() {
    }

    @Override
    public void init(InteractionDialogAPI dialog, Object specialData) {
        super.init(dialog, specialData);
        data = (DModRepairSpecial.DModRepairSpecialData) specialData;
    ...
    public DModRepairSpecial.DModRepairSpecialData getData() {
        return data;
    }
