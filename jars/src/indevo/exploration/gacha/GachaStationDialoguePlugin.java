...
public class GachaStationDialoguePlugin implements InteractionDialogPlugin {
    ...
    public void cycleMember(){
        ...
        cargo.removeCommodity(ItemIds.PARTS, partsToSacrifice);
        cargo.removeCommodity(ItemIds.RARE_PARTS, RARE_PART_COST_AMT);
        ...
        if (bestID == null || bestID.isEmpty()) {
            ...
            if (partsToSacrifice > 0) AddRemoveCommodity.addCommodityLossText(ItemIds.PARTS, Math.round(partsToSacrifice), text);
