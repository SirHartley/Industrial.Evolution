...
public class CannibalAttackIntel extends GhostShipIntelBase {

    private final int crewLosses;

    public CannibalAttackIntel(FleetMemberAPI member, boolean known) {
        super(member, known);
    ...
    public String getIcon() {
        return "graphics/icons/markets/dissidents.png";
    }
