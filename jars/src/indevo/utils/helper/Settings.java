...
public class Settings {
    ...
    public static final String ADMANUF = "Manufactory";
    public static final String ADASSEM = "Assembler";
    public static final String COMFORGE = "ComForge";
    public static final String COMARRAY = "MilArray";
    public static final String INTARRAY = "IndEvo_IntArray";
    public static final String ADINFRA = "CentBureau";
    public static final String SCRAPYARD = "ScrapYard";
    public static final String SUPCOM = "SupCom";
    public static final String EMBASSY = "Embassy";
    public static final String SENATE = "Senate";
    public static final String DRYDOCK = "dryDock";
    public static final String ACADEMY = "Academy";
    public static final String REQCENTER = "ReqCenter";
    public static final String ENGHUB = "EngHub";
    public static final String PRIVATEPORT = "PrivatePort";
    public static final String PIRATEHAVEN = "PirateHaven";
    ...
    public static final String ENABLE_DERELICTS = "Enable_Indevo_Derelicts";
    ...
    public static final String ENABLE_MINEFIELDS = "Enable_IndEvo_minefields";
    ...
    public static final String ENABLE_ARTILLERY = "Enable_IndEvo_Artillery";
    ...
    public static final String RG_COOLDOWN_TIME = "RG_cooldownTime";
    public static final String RG_RANGE = "RG_range";
    public static final String RESLAB_AUTO_DELIVER_TO_CLOSEST_DECON = "reslab_autoDeliverToClosestDecon";
    public static final String DECON_IGNORE_WHITELISTS = "IndEvo_DeconIgnoreWhitelists";
    public static final String HULLDECON_AUTO_DELIVER_TO_CLOSEST_FORGE = "hullDecon_autoDeliverToClosestForge";
    public static final String HULLDECON_DAYS_FRIGATE = "hullDecon_days_FRIGATE";
    public static final String HULLDECON_DAYS_DESTROYER = "hullDecon_days_DESTROYER";
    public static final String HULLDECON_DAYS_CRUISER = "hullDecon_days_CRUISER";
    public static final String HULLDECON_DAYS_CAPITAL_SHIP = "hullDecon_days_CAPITAL_SHIP";
    public static final String HULLFORGE_AUTO_QUEUE_SHIPS_UNTIL_EMPTY = "hullForge_autoQueueShipsUntilEmpty";
    public static final String HULLFORGE_AUTO_DELIVER_TO_CLOSEST_LAB = "hullForge_autoDeliverToClosestLab";
    public static final String HULLFORGE_DAYS_FRIGATE = "hullForge_days_FRIGATE";
    public static final String HULLFORGE_DAYS_DESTROYER = "hullForge_days_DESTROYER";
    public static final String HULLFORGE_DAYS_CRUISER = "hullForge_days_CRUISER";
    public static final String HULLFORGE_DAYS_CAPITAL_SHIP = "hullForge_days_CAPITAL_SHIP";
    public static final String ALPHA_CORE_RUNTIME = "alpha_core_runtime";
    public static final String BETA_CORE_RUNTIME = "beta_core_runtime";
    public static final String GAMMA_CORE_RUNTIME = "gamma_core_runtime";
    public static final String RESTO_FEE_FRIGATE = "restoFee_FRIGATE";
    public static final String RESTO_FEE_DESTROYER = "restoFee_DESTROYER";
    public static final String RESTO_FEE_CRUISER = "restoFee_CRUISER";
    public static final String RESTO_FEE_CAPITAL = "restoFee_CAPITAL";
    public static final String DAILY_OFFICER_SPAWN_CHANCE = "dailyOfficerSpawnChance";
    public static final String DAILY_ADMIN_SPAWN_CHANCE = "dailyAdminSpawnChance";
    public static final String PERSONALITY_TRAINING_DAY_COUNT = "personalityTrainingDayCount";
    public static final String PERSONALITY_TRAINING_COST = "personalityTrainingCost";
    public static final String ADMIN_TRAINING_DAY_COUNT = "adminTrainingDayCount";
    public static final String ADMIN_TRAINING_COST = "adminTrainingCost";
    public static final String MONTHLY_AI_STORAGE_COST = "monthlyAIStorageCost";
    public static final String VARIND_DELIVER_TO_PRODUCTION_POINT = "VarInd_deliverToProductionPoint";
