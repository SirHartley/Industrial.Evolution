...
public class EntityRemovalScript implements EveryFrameScript {
    ...
    public EntityRemovalScript(CustomCampaignEntityAPI entity, MarketAPI market, String prerequisiteIndustryID, boolean forceRemoval) {
        this.market = market;
        this.entity = entity;
