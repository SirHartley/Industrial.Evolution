...
public class IndEvo_PlanetMovingScript implements EveryFrameScript {

    public static final Logger log = Global.getLogger(IndEvo_PlanetMovingScript.class);
    boolean debug = false;
    ...
    public IndEvo_PlanetMovingScript(MarketAPI market, StarSystemAPI target) {
        this.market = market;
