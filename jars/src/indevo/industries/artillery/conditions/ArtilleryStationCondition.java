...
public class ArtilleryStationCondition extends BaseHazardCondition {
    ...
    protected void createTooltipAfterDescription(TooltipMakerAPI tooltip, boolean expanded) {
        ...
        if (isDestroyed())
            tooltip.addPara("It has been rendered %s. Restoration might be possible thanks to the robust repair systems, but it will require a functional orbital station.",
                    10f,
                    Misc.getTextColor(),
