...
public abstract class BaseSwitchableIndustry extends BaseIndustry implements SwitchableIndustryAPI {
...
//		}
        ...
        if (currTooltipMode == IndustryTooltipMode.ADD_INDUSTRY){
            ...
            tooltip.addPara(current.getDescription().getText1(), opad);
            addBaseSwitchableDesc(tooltip);
        }
