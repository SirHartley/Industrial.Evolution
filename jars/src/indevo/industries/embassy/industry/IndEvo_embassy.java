...
//Special Item handling
    ...
    public void setAmbassadorItemData(SpecialItemData data) {
        ...
        alignedFaction = IndEvo_AmbassadorItemHelper.getFactionForItem(data);
        monthsPassed = 0;
    }
    ...
    public void setSpecialItem(SpecialItemData special) {
        ...
        alignedFaction = IndEvo_AmbassadorItemHelper.getFactionForItem(special);
        monthsPassed = 0;
    }
    ...
    public String getCurrentImage() {
        if (getSpecialItem() != null) {
            switch (IndEvo_AmbassadorItemHelper.getFactionForItem(getSpecialItem()).getId()) {
