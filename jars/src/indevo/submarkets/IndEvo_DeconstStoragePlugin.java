...
public class IndEvo_DeconstStoragePlugin extends BaseSubmarketPlugin implements IndEvo_DynamicSubmarket {

    public static Logger log = Global.getLogger(IndEvo_DeconstStoragePlugin.class);
    ...
    public String getIllegalTransferText(FleetMemberAPI member, TransferAction action) {
        if (market.hasIndustry(IndEvo_ids.DECONSTRUCTOR)) {
            ...
            boolean printed = member.getVariant().hasHullMod(IndEvo_ids.PRINTING_INDICATOR);
