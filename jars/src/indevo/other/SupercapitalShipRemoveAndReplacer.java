...
@Deprecated
public class SupercapitalShipRemoveAndReplacer extends BaseCampaignEventListener {

    private static final String TAG = "supercapital";

    private SupercapitalShipRemoveAndReplacer() {
        super(false);
    }
    ...
    public static void init() {
        ...
        SupercapitalShipRemoveAndReplacer instance = new SupercapitalShipRemoveAndReplacer();
