...
@Deprecated
public class UniqueShipRemoveAndReplacer extends BaseCampaignEventListener implements FleetEventListener {
    ...
    private UniqueShipRemoveAndReplacer(String id) {
        super(false);
    ...
    public static void init(String targetShipId) {
        ...
        if (!mem.contains(LISTENER_INSTANCE + targetShipId)) {
            UniqueShipRemoveAndReplacer instance = new UniqueShipRemoveAndReplacer(targetShipId);
