...
public class ResearchProjectDonationCargoPicker {
    ...
    public static final Logger log = Global.getLogger(ResearchProjectDonationCargoPicker.class);
    ...
    public static void init(ResearchProjectDialoguePlugin plugin, String id) {
        final float width = 310;
        InteractionDialogAPI dialog = plugin.dialog;
        final ResearchProject project = ResearchProjectTemplateRepo.RESEARCH_PROJECTS.get(id);
