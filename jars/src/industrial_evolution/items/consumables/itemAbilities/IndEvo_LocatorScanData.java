...
public class IndEvo_LocatorScanData  {

    public IndEvo_LocatorScanData(IndEvo_LocatorAbilityPlugin ability){
        this.ability = ability;
    }

    private IndEvo_LocatorAbilityPlugin ability;
    ...
    public void maintainSystemPings() {
        ...
        for (StarSystemAPI system : Global.getSector().getStarSystems()) {
            ...
            float g = IndEvo_LocatorSystemRatingUpdater.getRating(system);
