package industrial_evolution.plugins.derelicts;
...
public class IndEvo_DerelictStationPlacer {
    protected Random random;

    public static boolean DEBUG = Global.getSettings().isDevMode();
    public static final Logger log = Global.getLogger(IndEvo_DerelictStationPlacer.class);
    ...
    public IndEvo_DerelictStationPlacer() {
    }
    ...
    public void init() {
        ...
        log.info("IndEvo_DerelictStationPlacer");
    ...
    public boolean addArsenalStation(BaseThemeGenerator.StarSystemData data, float chanceToAddAny) {
        ...
        String type = IndEvo_ids.ARSENAL_ENTITY;
        ...
        if(Global.getSettings().getBoolean("Enable_IndEvo_minefields") && loc.type.equals(LocationType.PLANET_ORBIT)){
            ...
            if (t != null){
                ...
                if (m != null) {
                    m.addCondition(IndEvo_ids.COND_MINERING);
                    ((IndEvo_MineFieldCondition) m.getCondition(IndEvo_ids.COND_MINERING).getPlugin()).addMineField();
                    IndEvo_modPlugin.log(data.system.getName() + " arsenal station, mine ring added");
                }
            }
        }
    ...
    public boolean addLabStations(BaseThemeGenerator.StarSystemData data, float chanceToAddAny) {
        ...
        if (loc != null) {
            addStation(loc, data, IndEvo_ids.LAB_ENTITY, Factions.NEUTRAL);
...
//		station.entity.getMemoryWithoutUpdate().set(MemFlags.SALVAGE_DEFENDER_PROB, 1f);
    ...
    public static void addDebugStation() {
        ...
        CustomCampaignEntityAPI entity = addStationToFirstPlanet(loc, 100f, IndEvo_ids.ARSENAL_ENTITY);
