package industrial_evolution.plugins.salvage;
...
import industrial_evolution.campaign.rulecmd.researchProjects.IndEvo_DropDataCreator;
...
public class IndEvo_ConsumableItemDropListener implements ShowLootListener {
    public static void register() {
        ListenerManagerAPI manager = Global.getSector().getListenerManager();
        if (!manager.hasListenerOfClass(IndEvo_ConsumableItemDropListener.class))
            manager.addListener(new IndEvo_ConsumableItemDropListener(), true);
    }
    ...
    public void reportAboutToShowLootToPlayer(CargoAPI loot, InteractionDialogAPI dialog) {
        ...
        if (dialog.getInteractionTarget() instanceof CampaignFleetAPI) {
            ...
            dropRandom.add(IndEvo_DropDataCreator.createDropData("indEvo_consumables", flooredChances));
