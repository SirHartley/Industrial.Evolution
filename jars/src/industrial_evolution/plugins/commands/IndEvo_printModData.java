package industrial_evolution.plugins.commands;
...
public class IndEvo_printModData implements BaseCommand {
    @Override
    public CommandResult runCommand(String args, CommandContext context) {
        ...
        for (LocationAPI location : Global.getSector().getAllLocations()){
            for (SectorEntityToken t : location.getAllEntities()){
                ...
                //sectorEntityTokens
                if (t.getCustomEntityType() != null && (t.getCustomEntityType().toLowerCase().contains("industrial_evolution") || t.getCustomEntityType().toLowerCase().contains("splinterfleet"))){
                ...
                if (t instanceof BaseCampaignEntity){
                    for (EveryFrameScript s : ((BaseCampaignEntity) t).getScripts()){
                        if (s.getClass().getName().toLowerCase().contains("industrial_evolution") || s.getClass().getName().toLowerCase().contains("splinterfleet")) {
        ...
        for (Object o : Global.getSector().getListenerManager().getListeners(Object.class)){
            ...
            if (o.getClass().getName().toLowerCase().contains("industrial_evolution") || o.getClass().getName().toLowerCase().contains("splinterfleet")) {
        ...
        int ambassadorAmt = Global.getSector().getImportantPeople().getPeopleWithPost(IndEvo_AmbassadorIdHandling.POST_AMBASSADOR).size();
