package industrial_evolution.plugins;

import com.fs.starfarer.api.*;
import industrial_evolution.artillery.scripts.IndEvo_EyeIndicatorScript;
import industrial_evolution.artillery.trails.IndEvo_MagicCampaignTrailPlugin;
import com.fs.starfarer.api.campaign.*;
import com.fs.starfarer.api.campaign.econ.Industry;
import com.fs.starfarer.api.campaign.econ.InstallableIndustryItemPlugin;
import com.fs.starfarer.api.campaign.econ.MarketAPI;
import industrial_evolution.items.consumables.listeners.IndEvo_LocatorSystemRatingUpdater;
import industrial_evolution.items.consumables.listeners.IndEvo_SpooferItemKeypressListener;
import com.fs.starfarer.api.campaign.listeners.ListenerManagerAPI;
import com.fs.starfarer.api.combat.MissileAIPlugin;
import com.fs.starfarer.api.combat.MissileAPI;
import com.fs.starfarer.api.combat.ShipAPI;
import industrial_evolution.superstructures.gacha.IndEvo_GachaStationCampaignPlugin;
import industrial_evolution.superstructures.gacha.IndEvo_GachaStationPlacer;
import com.fs.starfarer.api.impl.campaign.econ.impl.BaseIndustry;
import com.fs.starfarer.api.impl.campaign.econ.impl.BaseInstallableItemEffect;
import industrial_evolution.industries.IndEvo_OrbitalStation;
import com.fs.starfarer.api.impl.campaign.econ.impl.ItemEffectsRepo;
import industrial_evolution.industries.courierport.listeners.ShippingManager;
import industrial_evolution.items.installable.IndEvo_SpecialItemEffectsRepo;
import com.fs.starfarer.api.impl.campaign.ids.*;
import com.fs.starfarer.api.impl.campaign.intel.contacts.ContactIntel;
import industrial_evolution.campaign.rulecmd.researchProjects.IndEvo_DoritoGunFoundChecker;
import com.fs.starfarer.api.impl.campaign.terrain.AsteroidSource;
import industrial_evolution.campaign.terrain.conditions.IndEvo_MineFieldCondition;
import industrial_evolution.campaign.terrain.listeners.IndEvo_RecentJumpListener;
import com.fs.starfarer.api.loading.IndustrySpecAPI;
import industrial_evolution.plugins.ambassadorPlugins.IndEvo_ambassadorPersonManager;
import industrial_evolution.plugins.converters.IndEvo_ConverterRepResetScript;
import industrial_evolution.plugins.derelicts.IndEvo_ArtilleryStationPlacer;
import industrial_evolution.plugins.derelicts.IndEvo_DerelictStationPlacer;
import industrial_evolution.plugins.derelicts.IndEvo_RuinsManager;
import industrial_evolution.plugins.derelicts.IndEvo_SalvageSpecialAssigner;
import industrial_evolution.plugins.economy.IndEvo_ConsumableItemMarketAdder;
import industrial_evolution.plugins.economy.IndEvo_PartsManager;
import industrial_evolution.plugins.notifications.IndEvo_depositMessage;
import industrial_evolution.plugins.salvage.IndEvo_ConsumableItemDropListener;
import industrial_evolution.plugins.salvage.IndEvo_SpecialItemDropsListener;
import industrial_evolution.plugins.timers.IndEvo_TimeTracker;
import industrial_evolution.plugins.timers.IndEvo_raidTimeout;
import industrial_evolution.plugins.update.IndEvo_DetachmentAbilityAdder;
import industrial_evolution.plugins.update.IndEvo_NewGameIndustryPlacer;
import industrial_evolution.IndEvo_IndustryHelper;
import industrial_evolution.campaign.ids.IndEvo_ids;
import industrial_evolution.splinterFleet.SplinterFleetCampignPlugin;
import industrial_evolution.splinterFleet.dialogue.DialogueInterceptListener;
