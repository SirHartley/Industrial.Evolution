...
import industrial_evolution.campaign.entityplugins.IndEvo_ExplosionScript;
...
public class IndEvo_ItemChoiceSpecial extends BaseSalvageSpecial {
    ...
    public static class ItemChoiceSpecialData implements SalvageSpecialInteraction.SalvageSpecialData {
        ...
        public SalvageSpecialInteraction.SalvageSpecialPlugin createSpecialPlugin() {
            return new IndEvo_ItemChoiceSpecial();
        }
    }

    private IndEvo_ItemChoiceSpecial.ItemChoiceSpecialData data;

    public IndEvo_ItemChoiceSpecial() {
    }
    ...
    public void init(InteractionDialogAPI dialog, Object specialData) {
        ...
        data = (IndEvo_ItemChoiceSpecial.ItemChoiceSpecialData) specialData;
        fixSpecialData();

        Global.getLogger(IndEvo_ItemChoiceSpecial.class).info("Resolving " + data.itemID + " to " + specialItemData.getData());
