package industrial_evolution.campaign.terrain;
...
import static industrial_evolution.campaign.terrain.conditions.IndEvo_MineFieldCondition.PLANET_KEY;

public class IndEvo_MineFieldTerrainPlugin extends IndEvo_MineBeltTerrainPlugin {
    ...
    public IndEvo_MineFieldTerrainPlugin.MineFieldParams params;

    public void init(String terrainId, SectorEntityToken entity, Object param) {
        super.init(terrainId, entity, param);
        params = (IndEvo_MineFieldTerrainPlugin.MineFieldParams) param;
        name = params.name;
        if (name == null) {
            name = "Minefield";
        }
    ...
    protected void createMineField() {
        if (!(params instanceof IndEvo_MineFieldTerrainPlugin.MineFieldParams)) return;
