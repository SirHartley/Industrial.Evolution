...
public class IndEvo_StringHelper {
...
*/
    ...
    public static String getString(String category, String id, boolean ucFirst) {
        ...
        try {
            ...
            Global.getLogger(IndEvo_StringHelper.class).warn(ex);
            return "[INVALID]" + id;
        }
    ...
    public static String getFactionShortName(FactionAPI faction) {
        if (faction.isPlayerFaction() && !Misc.isPlayerFactionSetUp()) {
            return IndEvo_StringHelper.getString("player");
        } else {
        ...
        for (String entry : strings) {
            ...
            if (num < strings.size()) {
                if (oxfordComma || !includeAnd || num <= strings.size() - 1)
                    str += ", ";
                if (includeAnd)
                    str += IndEvo_StringHelper.getString("and") + " ";
            }
        }
        return str;
    }
    ...
    public static String getDayOrDays(Integer days) {
        String day = IndEvo_StringHelper.getString("days");
        if (days == 1) day = IndEvo_StringHelper.getString("day");
    ...
    public static String getHeOrShe(FullName.Gender gender) {
        return gender == MALE ? IndEvo_StringHelper.getString("he") : IndEvo_StringHelper.getString("she");
    }

    public static String getHimOrHer(FullName.Gender gender) {
        return gender == MALE ? IndEvo_StringHelper.getString("him") : IndEvo_StringHelper.getString("her");
    }
