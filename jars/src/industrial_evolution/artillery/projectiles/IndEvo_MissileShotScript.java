package industrial_evolution.artillery.projectiles;
...
import static industrial_evolution.artillery.projectiles.IndEvo_MissileCarrierEntityPlugin.AVERAGE_PROJ_IMPACT_TIME;
...
public class IndEvo_MissileShotScript implements EveryFrameScript {
    ...
    public IndEvo_MissileShotScript(SectorEntityToken origin, SectorEntityToken target, int missileAmt) {
        this.origin = origin;
        this.target = target;
    ...
    public void advance(float amount) {
        ...
        //IndEvo_RenderTemporaryIndicator.spawn(origin.getContainingLocation(), anticipatedTargetLoc, Color.YELLOW);
        ...
        for (int i = 0; i < missileAmt; i++) {
            ...
            //IndEvo_RenderTemporaryIndicator.spawn(origin.getContainingLocation(), fuzzedTarget, Color.RED);
            ...
            IndEvo_MissileCarrierEntityPlugin.MissileParams params = new IndEvo_MissileCarrierEntityPlugin.MissileParams(
                    origin,
                    fuzzedTarget,
            ...
            IndEvo_MissileCarrierEntityPlugin.spawn(params);
        }
