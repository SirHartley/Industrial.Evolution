...
public class IndEvo_TradeCenter extends BaseIndustry implements MarketImmigrationModifier {
    ...
    public String getUnavailableReason() {
        if (balanceChange && !IndEvo_IndustryHelper.isOnlyInstanceInSystemExcludeMarket(getId(), market.getStarSystem(), market, market.getFaction()))
    ...
    protected void addAlphaCoreDescription(TooltipMakerAPI tooltip, AICoreDescriptionMode mode) {
        ...
        if (mode == AICoreDescriptionMode.INDUSTRY_TOOLTIP) {
            ...
            if (balanceChange) text.addPara(pre + "Reduces upkeep cost by %s. Reduces demand by %s unit. " +
                    ...
                    "" + (int) ((1f - UPKEEP_MULT) * 100f) + "%", IndEvo_StringHelper.getAbsPercentString(ALPHA_CORE_TARIFF_MULT, true),
                    str);
