...
public class IndEvo_edict_forced_reloc extends IndEvo_baseEdict implements MarketImmigrationModifier {
    ...
    public void modifyIncoming(MarketAPI market, PopulationComposition incoming) {
        int otherPlanetCount = IndEvo_IndustryHelper.getMarketsInLocation(this.market.getStarSystem(), this.market.getFactionId()).size() - 1;
    ...
    public void printEdictEffectText(TextPanelAPI text, MarketAPI market) {
        int otherPlanetCount = IndEvo_IndustryHelper.getMarketsInLocation(market.getStarSystem(), market.getFactionId()).size() - 1;
        ...
        for (MarketAPI market1 : IndEvo_IndustryHelper.getMarketsInLocation(market.getStarSystem(), market.getFactionId())) {
