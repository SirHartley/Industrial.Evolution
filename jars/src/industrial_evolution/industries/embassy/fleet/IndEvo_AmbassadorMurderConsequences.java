package industrial_evolution.industries.embassy.fleet;
...
import static industrial_evolution.campaign.rulecmd.salvage.special.IndEvo_CreditStashSpecial.makeFleetInterceptPlayer;
...
public class IndEvo_AmbassadorMurderConsequences implements EveryFrameScript, FleetEventListener {
    ...
    public IndEvo_AmbassadorMurderConsequences(PersonAPI ambassador) {
